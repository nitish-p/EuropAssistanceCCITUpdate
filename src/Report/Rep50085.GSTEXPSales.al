Report 50085 GSTEXPSales
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/GSTEXPSales.rdl';
    UsageCategory = Lists;
    ApplicationArea = all;
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(Sales_Invoice_Line_Amount_To_Customer; '')//"Sales Invoice Line"."Amount To Customer"
                {
                }
                column(GST_percent; '')//"Sales Invoice Line"."GST %"
                {
                }
