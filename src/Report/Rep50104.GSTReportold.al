Report 50104 "GST Report old"
{
                ...
                if RecDetailedGSTLedEntry.FindSet then
                    repeat
                        if RecDetailedGSTLedEntry."GST Component Code" = 'SGST' then begin
                            SGSTAmt := RecDetailedGSTLedEntry."GST Amount";
                        ...
                        if RecDetailedGSTLedEntry."GST Component Code" = 'CGST' then begin
                            CGSTAmt := RecDetailedGSTLedEntry."GST Amount";
                            CGSTGLAcc := RecDetailedGSTLedEntry."G/L Account No.";
                            CGSTEntryNo := RecDetailedGSTLedEntry."Entry No.";
                        ...
                        if RecDetailedGSTLedEntry."GST Component Code" = 'IGST' then begin
                            IGSTAmt := RecDetailedGSTLedEntry."GST Amount";
                            IGSTGLAcc := RecDetailedGSTLedEntry."G/L Account No.";
                            IGSTEntryNo := RecDetailedGSTLedEntry."Entry No.";
                            "HSN/SACCode" := RecDetailedGSTLedEntry."HSN/SAC Code";
    ...
    begin
        ExcelBuf.SetFriendlyFilename('Booking FOREIGN Vendors Report.xlsx');//Nkp
        ExcelBuf.OpenExcel();
    ...
    begin
        ...
        ExcelBuf.AddColumn(SGSTEntryNo, false, '', false, false, false, '', ExcelBuf."cell type"::Number);
        ExcelBuf.AddColumn(CGSTEntryNo, false, '', false, false, false, '', ExcelBuf."cell type"::Number);
        ExcelBuf.AddColumn(IGSTEntryNo, false, '', false, false, false, '', ExcelBuf."cell type"::Number);
    end;
