Report 50021 "Credit Note-GST"
{

    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Credit Note-GST.rdl';
    UsageCategory = Lists;
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(AmounttoCustomer_SalesCrMemoHeader; '')//ROUND("Sales Cr.Memo Line"."Amount To Customer",0.01)
            {
            }
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    // AmtToCust := Round(AmtToCust + "Sales Cr.Memo Line"."Line Amount");
                    //AmtToCust := AmtToCust + CGSTAmount + SGSTAmount + IGSTAmount;
