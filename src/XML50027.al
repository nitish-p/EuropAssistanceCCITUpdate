...
// xmlport 50027 "RAW JV Credit Memo upload"
// {
//     // Pallavi 14082017
//     // 1 created xmlport for uploading credit memo
...
//     // 7 modifed order of fields
//     // 8 added code for vlaidating applied entry no -validate rawdata()
//     // 9 added code for flowing applied doc no =  ValidateRawData()
//     // Pallavi 04092017
//     // added code ofr taxable , bill of supply
//     // Pallavi 18092017
//     // added code for fitlering customer no - on entry no in function ValidateRawData()
//     // Pallavi 22092017
//     // uncommented code for  posted external doc no - function ValidateRawData()
//     // added code for removing (-) sign at the time of application = InsertSalesDocument()
...
//         textelement(Root)
//         {
//             tableelement("Raw JV Data"; "E-Collection API")
//             {
//                 XmlName = 'RawJV';
//                 fieldelement(PostingDate; "Raw JV Data".)
//                 {
//                 }
...
//     var
//         RawUpdateLog: Record "E-Collection API";
//         FoundError: Boolean;
//         RawUpdateLog2: Record "E-Collection API";
...
//     var
//         RawDataLog: Record "50014";
//         RowNumber: Integer;
//         UpdateRawData: Codeunit "50000";
//         PolicyNumber: Code[30];
//         RawSalesLog: Record "50002";
//         CaseIdText: Text[250];
//         Item: Record "27";
//         ItemUOM: Record "5404";
//         Location: Record "14";
...
//         Sales_HDRInsert: Record "36";
//         Sales_HDRModify: Record "36";
//         SalesLine: Record "37";
...
//         RecSalesLine2: Record "37";
//         RecSalesLine3: Record "37";
...
//         "Sales&RcSetup": Record "311";
//         LineInsert: Integer;
//         Evaluated_Vehicle_Identification_No: Code[30];
//         CustRec: Record "18";
//         XMLRejectMAster: XMLport "50001";
//         Rate: Decimal;
//         UOM: Record "204";
